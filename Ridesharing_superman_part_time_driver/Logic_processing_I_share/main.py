...
import random
import datetime
from service.I_Share_Algorithm import combination_of_multiple_orders, dual_side_taxi_searching, recommendation, find_the_nearest_empty_car_for_one
...
while endtime <= Timeframe.untildatetime:
    ...
    for cluster in pickup_clusters:
        ...
        if len(cluster.query_list) > RON_threshold:
            ...
            # 拼单算法（包括寻找空车司机以及路径规划）
            combination_of_multiple_orders(cluster.query_list, regl_Hexg_grids, driver_list, starttime, time_slot)
